...
- Added Kamisato Ayato character cards, skills and constellations
...
- Added Haran Geppaku Futsu weapon
- Added Vermillion Hereafter and Echoes of an Offering artifact sets

## [5.0.0] - 2021-01-25

## Added

- Total overhaul of UI. A referesh of the current website, with better UI for mobile. 
- Added donate button
...
### Fixed
- Corrected spelling error in Xinyan's name on the character build card
...
### Added
- Added Eula to card designs and team selection
