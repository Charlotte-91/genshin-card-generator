...
export default {
  ...
  created() {
      ...
      team2.src = require('@/assets/teams/' + (this.$route.params.team2).split(" ").join("")  + '-small.png');
      team2.onload = () => {
        this.team2 = team2;
      };
      const team3 = new window.Image();
      team3.src = require('@/assets/teams/' + (this.$route.params.team3).split(" ").join("")  + '-small.png');
      team3.onload = () => {
        this.team3 = team3;
      };
      const team4 = new window.Image();
      team4.src = require('@/assets/teams/' + (this.$route.params.team4).split(" ").join("")  + '-small.png');
      team4.onload = () => {
        this.team4 = team4;
      };
